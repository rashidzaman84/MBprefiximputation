...
public class PrefixImputationStatic_APTE {
...
//	public PrefixImputationStatic(LocalModelStructure lms) {
//		this.lms = lms;
//	}
	...
	public static /*Pair<XTrace, Integer>*/ ArrayList<String> imputePrefix(LocalModelStructure_APTE lms, String newEventName/*, XTrace tr*/){  //sets prefix for imputation and its size
