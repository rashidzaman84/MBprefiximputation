...
public class ForgettingCases_APTE {
	protected LocalModelStructure_APTE lms;
	protected LocalConformanceTracker_APTE lct;
	/*public CasesRemoval(LocalModelStructure lms, Set<Map.Entry<String, LocalConformanceStatus>> EventStore) {
		
	}*/
	public ForgettingCases_APTE(LocalModelStructure_APTE lms, LocalConformanceTracker_APTE localConformanceTracker_APTE) {
		this.lms = lms;
		this.lct = localConformanceTracker_APTE;
	}
	...
	public String selectCaseToBeForgotten() {
		...
		for (Map.Entry<String, LocalConformanceStatus_APTE> entry : lct.entrySet()) {
		    String caseId = entry.getKey();
//		    if(caseId.equals(/*"199098""199071""179841""198113"*/"173757") ) {
//				//System.out.println("Found!!!!");
//			}
		    LocalConformanceStatus_APTE lcs = entry.getValue();
