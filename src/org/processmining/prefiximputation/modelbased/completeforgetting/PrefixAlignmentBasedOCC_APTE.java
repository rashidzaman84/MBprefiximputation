...
public class PrefixAlignmentBasedOCC_APTE {
	...
	private LocalModelStructure_APTE lms;
	...
	public PrefixAlignmentBasedOCC_APTE(LocalModelStructure_APTE lms2) {
		this.lms = lms2;
...
//		}
		...
		return partialAlignment.getCost();
